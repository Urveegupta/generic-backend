...
public abstract class _User extends BaseDataObject {
    ...
    public static final Property<List<SubmittedForm>> SUBMITTED_FORMS = Property.create("submittedForms", List.class);
    ...
    protected Object submittedForms;
    ...
    public void addToSubmittedForms(SubmittedForm obj) {
        addToManyTarget("submittedForms", obj, true);
    }

    public void removeFromSubmittedForms(SubmittedForm obj) {
        removeToManyTarget("submittedForms", obj, true);
    }

    @SuppressWarnings("unchecked")
    public List<SubmittedForm> getSubmittedForms() {
        return (List<SubmittedForm>)readProperty("submittedForms");
    }
    ...
    protected void writeState(ObjectOutputStream out) throws IOException {
        ...
        out.writeObject(this.submittedForms);
    }
    ...
    protected void readState(ObjectInputStream in) throws IOException, ClassNotFoundException {
        ...
        this.submittedForms = in.readObject();
    }
